...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','arim.py',9),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','arim.py',13),
  ('expression -> term','expression',1,'p_expression_term','arim.py',17),
  ('term -> term TIMES factor','term',3,'p_term_times','arim.py',21),
  ('term -> term DIVIDE factor','term',3,'p_term_div','arim.py',25),
  ('term -> factor','term',1,'p_term_factor','arim.py',29),
  ('factor -> NUMBER','factor',1,'p_factor_num','arim.py',33),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','arim.py',37),
]
